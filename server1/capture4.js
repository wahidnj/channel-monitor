...
function extractFramesFromVideo(videoURL, outputPattern) {
  ...
  const ffmpegCommand = `ffmpeg -i "${videoURL}" -q:v 1 -vf "fps=24,scale=800:600" -y image4/ATN-Music_%04d.jpg`;
...
// Usage example
const videoURL = 'http://lifetvbd.xyz:8080/samir10/samir10/217.ts';
