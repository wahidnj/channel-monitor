...
function extractFramesFromVideo(videoURL, outputPattern) {
  ...
  const ffmpegCommand = `ffmpeg -i "${videoURL}" -q:v 1 -vf "fps=24,scale=800:600" -y image5/Channel-24_%04d.jpg`;
  // const ffmpegCommand = `ffmpeg -i "${videoURL}" -q:v 1 -vf "fps=1,scale=800:600" -r 24 -y image3/RTV_%04d.jpg`;
...
// Usage example
const videoURL = 'http://lifetvbd.xyz:8080/samir4341/samir4341/83.ts';
// const videoURL = 'drink.mp4';
const outputPattern = './image5/output'; // Change this pattern as needed
