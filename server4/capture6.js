...
function extractFramesFromVideo(videoURL, outputPattern) {
  ...
  const ffmpegCommand = `ffmpeg -i "${videoURL}" -q:v 1 -vf "fps=24,scale=800:600" -y image6/EKATTOR-TV_%04d.jpg`;
...
// Usage example
const videoURL = 'http://lifetvbd.xyz:8080/samir4341/samir4341/318.ts';
